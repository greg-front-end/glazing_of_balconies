...
var changeModalState = function changeModalState(state) {
  var windowForm = document.querySelectorAll('.balcon_icons_img'),
      ...
      windowHeght = document.querySelectorAll('#height'),
  ...
  bindActionToElems('input', windowHeght, 'height');
...
/***/ "./src/js/modules/closeAllModals.js":
/*!******************************************!*\
  !*** ./src/js/modules/closeAllModals.js ***!
  \******************************************/
/*! exports provided: default */
...
var closeAllModals = function closeAllModals(selector) {
...
/* harmony default export */ __webpack_exports__["default"] = (closeAllModals);
...
/* harmony import */ var _closeAllModals__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./closeAllModals */ "./src/js/modules/closeAllModals.js");
...
var forms = function forms(state) {
  var form = document.querySelectorAll('form'),
      inputs = document.querySelectorAll('input'); // module for check inputs with value of number

  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_12__["default"])('input[name="user_phone"]'); // Object from message for statusDiv
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      e.preventDefault(); // create html div for show status after form sends

      var statusMessage = document.createElement('div');
      statusMessage.classList.add('status');
      item.appendChild(statusMessage); // if dataAttribute has prop(end) we append the key and value to formData
      ...
      var clearModalState = function clearModalState(obj) {
      ...
      postData('assets/server.php', formData).then(function (res) {
        ...
        Object(_closeAllModals__WEBPACK_IMPORTED_MODULE_13__["default"])('[data-modal');
        setTimeout(function () {
  ...
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    trigger.forEach(function (item) {
      item.addEventListener('click', function (e) {
        ...
        Object(_closeAllModals__WEBPACK_IMPORTED_MODULE_1__["default"])('[data-modal]');
